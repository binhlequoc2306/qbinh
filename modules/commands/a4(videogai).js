...
const keyWords = [
  "video gai", "video gái", "gái", "gai", "múp", "girl", "Gái", "Girl", "Gai",
  "gái xinh", "gái xinh đâu", "Gái xinh", "Video gái", "nhìn múp", "bot ơi gái xinh đâu"
];

// Lowercase tất cả để so sánh dễ dàng
const keyWordsLower = keyWords.map(k => k.toLowerCase());

module.exports.handleEvent = async ({ api, event }) => {
  if (!event.body) return;
  const msg = event.body.toLowerCase();
  // Kiểm tra có từ khóa nào khớp đầu câu không
  ...
  // Danh sách video
  const link = ["https://i.imgur.com/8Phezwv.mp4",
